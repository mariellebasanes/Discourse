          ...
          <div class="row g-0 px-5">
            ...
            <div class="col-12 mb-2">
              <div class="d-flex justify-content-between align-items-center">
                <a href="/Discourse/pages/version/community.php" class="badge rounded-pill px-5 py-2 fs-8 text-decoration-none text-hover-primary" style="background-color:#dce8df;color:#3a5c45;">FEUTech</a>
            ...
            <div class="col-12 mb-2">
              <div class="d-flex gap-3 align-items-center">
                ...
                <a href="/Discourse/pages/version/index.php" class="badge rounded-pill px-5 py-2 fs-8 text-decoration-none text-hover-primary" style="background-color:#dce8df;color:#3a5c45;">TECHNOLOGY</a>
              </div>
            </div>
          ...
          <div class="row g-0 px-5">
            ...
            <div class="col-12 mb-2">
              <div class="d-flex gap-3 align-items-center">
                ...
                <div class="d-flex flex-column">
                  <span class="fs-6 fw-bold text-gray-800">Anonymous</span>
                  <span class="text-muted fs-8"><i class="bi bi-clock me-1 fs-8"></i>1d ago</span>
                </div>
                <a href="/Discourse/pages/version/index.php" class="badge rounded-pill px-5 py-2 fs-8 text-decoration-none text-hover-primary" style="background-color:#dce8df;color:#3a5c45;">TECHNOLOGY</a>
              </div>
      ...
      <div class="d-flex">
        ...
        <div class="d-flex flex-column py-5 flex-grow-1">
          <div class="row g-0 px-5">
            ...
            <div class="col-12 mb-2">
              <div class="d-flex justify-content-between align-items-center">
                <a href="/Discourse/pages/version/community.php" class="badge rounded-pill px-5 py-2 fs-8 text-decoration-none text-hover-primary" style="background-color:#dce8df;color:#3a5c45;">FEULife</a>
                <button class="btn btn-sm" data-bs-toggle="modal" data-bs-target="#modalReportPost">
                  <i class="bi bi-flag me-1"></i> Report
                </button>
              </div>
            ...
            <div class="col-12 mb-2">
              <div class="d-flex gap-3 align-items-center">
                ...
                <a href="/Discourse/pages/version/index.php" class="badge rounded-pill px-5 py-2 fs-8 text-decoration-none text-hover-primary" style="background-color:#dce8df;color:#3a5c45;">FEU</a>
              </div>
            </div>
          ...
          <div class="row g-0 px-5">
            ...
            <div class="col-12 mb-2">
              <div class="d-flex gap-3 align-items-center">
                ...
                <div class="d-flex flex-column">
                  <a href="/Discourse/pages/version/profile-other.php" class="fs-6 fw-bold text-gray-800 text-hover-primary">Catalina Smith</a>
                  <span class="text-muted fs-8"><i class="bi bi-clock me-1 fs-8"></i>1d ago</span>
                </div>
                <a href="/Discourse/pages/version/index.php" class="badge rounded-pill px-5 py-2 fs-8 text-decoration-none text-hover-primary" style="background-color:#dce8df;color:#3a5c45;">TECHNOLOGY</a>
              </div>

                                            ...
                                            <div class="card border-0 shadow-sm mb-5">
                                                ...
                                                <div class="card-body p-0">
                                                    <a href="/Discourse/pages/view/view-post-tech.php" class="d-flex align-items-start gap-3 p-4 border-bottom text-decoration-none text-hover-primary">
                                                        ...
                                                        <div>
                                                            <div class="fs-7 fw-semibold text-gray-800 mb-1">The silent revolution in edge AI — why on-device inference is changing everything</div>
                                                            <div class="text-muted fs-8">Technology · 1d ago</div>
                                                        </div>
                                                    </a>
                                                    <a href="/Discourse/pages/view/view-post-anonymous.php" class="d-flex align-items-start gap-3 p-4 border-bottom text-decoration-none text-hover-primary">
                                                    ...
                                                    <a href="/Discourse/pages/view/view-post-review.php" class="d-flex align-items-start gap-3 p-4 text-decoration-none text-hover-primary">
                                                        <span class="badge badge-light-success rounded-pill px-3 py-2 fs-8 flex-shrink-0"style="color:#3a5c45;">#03</span>
                                                        <div>
                                                            <div class="fs-7 fw-semibold text-gray-800 mb-1">Review: FEU Tech library study rooms — worth booking or just use the hallway?</div>
                                                            <div class="text-muted fs-8">Academics · 2d ago</div>
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
